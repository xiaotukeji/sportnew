...
ALTER TABLE `diy_page` CHANGE COLUMN `template` `template` VARCHAR(255) DEFAULT '' COMMENT '模板名称';

ALTER TABLE `diy_page` MODIFY `page_title` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '页面名称（用于后台展示）' AFTER `id`;
