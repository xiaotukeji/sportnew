        ...
        <el-card class="box-card !border-none" shadow="never">
            <el-form :model="formData" label-width="90px" ref="formRef" :rules="formRules" class="page-form">
                ...
                <el-form-item :label="t('startYear')" prop="start_year">
                    <el-input v-model="formData.start_year" clearable :placeholder="t('startYearPlaceholder')" class="input-width" />
                </el-form-item>
                
                <el-form-item :label="t('endYear')" >
                    <el-input v-model="formData.end_year" clearable :placeholder="t('endYearPlaceholder')" class="input-width" />
                </el-form-item>
...
import { getSportEventSeriesInfo,addSportEventSeries,editSportEventSeries } from '@/addon/sport/api/sport_event_series';
...
const setFormData = async (id:number = 0) => {
    ...
    const data = await (await getSportEventSeriesInfo(id)).data
...
,
    start_year: [
        { required: true, message: t('startYearPlaceholder'), trigger: 'blur' },
        
    ]
,
    end_year: [
        { required: true, message: t('endYearPlaceholder'), trigger: 'blur' },
...
const onSave = async (formEl: FormInstance | undefined) => {
    ...
    await formEl.validate(async (valid) => {
       if (valid) {
           ...
           const save = id ? editSportEventSeries : addSportEventSeries
           save(data).then(res => {
               loading.value = false
               history.back()
           }).catch(err => {
